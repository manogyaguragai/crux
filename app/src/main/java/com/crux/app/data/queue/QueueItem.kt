 ...
 * [message] carries the outcome once terminal — a short result on DONE, the reason on FAILED. [source]
 * remembers whether the line was typed or spoken, so a voice capture keeps its "via voice" provenance
 * even though it is processed the same way.
 */
